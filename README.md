...
- 戦士のカートリッジを使う場合、生成されたバイナリのサイズが 512KiB を超える場合があります。その際は LittleFS の容量を小さくする必要があります。
...
- talk 文の固定語には対応していません。
- talk 文で音声が出ないことがあります。
...
- [fmgen & uPD7752風味音声合成エンジン](http://retropc.net/cisc/sound/)
